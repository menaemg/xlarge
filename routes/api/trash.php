...
Route::delete('/users/delete/{user}' , 'Api\V1\trash\UserController@destory');

// posts trash
Route::get('/posts' , 'Api\V1\trash\PostController@trashed') ;
Route::post('/posts/restore/{post}' , 'Api\V1\trash\PostController@restore');
Route::delete('/posts/delete/{post}' , 'Api\V1\trash\PostController@destory');
...
Route::delete('/categories/delete/{category}' , 'Api\V1\trash\CategoryController@destory');
...
Route::delete('/comments/delete/{comment}' , 'Api\V1\trash\CommentController@destory');
...
Route::delete('/replies/delete/{replay}' , 'Api\V1\trash\ReplayController@destory');
